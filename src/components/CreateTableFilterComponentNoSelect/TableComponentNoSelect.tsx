...
import CreateTableFilterComponentNoSelect from './CreateTableFilterComponentNoSelect';

const TableComponentNoSelect: React.FC = () => {
  ...
  return (
    <div>
      ...
      <CreateTableFilterComponentNoSelect Data={tableData} onRowSelected={handleClickRowsChange} />
    </div>
  );
};

export default TableComponentNoSelect;
